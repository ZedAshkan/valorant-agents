        ...
        <div className="col">
          <div className="flex flex-col items-start m-3">
            ...
            <div className="bg-white overflow-hidden rounded-xl mt-3 md:mt-12 self-center mb-5 md:self-start">
              <form className="flex">
                <input className="outline-none px-3 py-2 text-slate-600 font-medium w-[250px]" type="email" placeholder="email" />
                <button className="bg-slate-600 hover:bg-slate-800 py-3 px-3 transition duration-300">subscribe</button>
              </form>
            </div>
          </div>
        </div>
